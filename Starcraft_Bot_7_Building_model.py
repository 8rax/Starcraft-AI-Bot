...
#32 features, windows are 3 by 3, input_shape = 176  * 200 * 3 
...
#20% dropout, 20% of the data we toss it, the objective is to reduce bias, makes things more robust
...
#We take the folder with all the train data
#Each file is a game we won, each file contains 30-60 actions that it took that we saved
